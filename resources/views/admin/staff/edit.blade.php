                ...
                <form method="POST" action="{{ route('admin.staff.update', $staff) }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone', $staff->phone)" />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="role" class="block mt-1 w-full" type="text" name="role" :value="old('role', $staff->role)" required placeholder="e.g. Senior Stylist, Consultant" />
