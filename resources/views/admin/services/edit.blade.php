            ...
            <div class="p-6 text-slate-900">
                <form method="POST" action="{{ route('admin.services.update', $service) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="3" class="border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('description', $service->description) }}</textarea>
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <a href="{{ route('admin.services.index') }}" class="text-sm text-slate-600 hover:text-slate-900 mr-4">Cancel</a>
                        <x-primary-button>
                            {{ __('Update Service') }}
                        </x-primary-button>
                    </div>
