            ...
            <div class="p-6 text-slate-900">
                <form method="POST" action="{{ route('admin.services.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="description" name="description" rows="3" class="border-slate-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('description') }}</textarea>
